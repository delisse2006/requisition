    ...
    */
    ...
    protected function create(array $data)
    {
        return User::create([
            ...
            'security_answer' => $data['security_answer'], // ✅ Will be auto-hashed by mutator
        ]);
    }
    ...
    {
        return redirect($this->redirectTo)->with('success', 'Registration successful! Welcome to the system.');
    }
}